    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p> An e-comerce website is an online platform where businesses sell products or services directly to customers over the internet.</p>
          <p>E-commerce websites typically feature product listings, shopping carts, secure payment processing, and user account management.</p>
        </div>
      </div>
